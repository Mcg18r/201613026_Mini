...
public class Graph<T extends Comparable<T>> implements Serializable {
	 ...
	 * Graph
	 * 
	 * NOTE: Duplicate vertices and edges ARE allowed. NOTE: Copies the vertex and
	 * edge objects but does NOT store the Collection parameters itself.
	 * 
	...
	public void addVnE(Vertex<T> v1, Vertex<T> v2, int costV1toV2, int costV2toV1)
	{
		Edge<T> e1= new Edge<T>(costV1toV2, v1, v2);
		Edge<T> e2= new Edge<T>(costV2toV1, v2, v1);
		...
		this.allEdges.add(e2);
		//this.allVertices.add(v1);
		//this.allVertices.add(v2);
		
	}
	
	public void addVnOneE(Vertex<T> v1, Vertex<T> v2, int costV1toV2)
	{
		Edge<T> e1= new Edge<T>(costV1toV2, v1, v2);
