 ...
 *
 */
public class DFSPane extends GridPane{
	/*---------------------- DECLARATIONS--------------------------------------------*/
	...
	public DFSPane() {
        ...
        contextMenu.getItems().addAll(menuAddVertex, menuAddEdge);	//add the items to the menu
		...
		circle.setOnContextMenuRequested(e->{
			{
				...
				menuWorkout.setOnAction(f->{
					...
					System.out.println("root Vertex "+vList.get(0));
					System.out.println("end Vertex "+vertex);
					
					Stack<Node> nodeStack=NodeSet(vList.get(0), vertex);
					
					while(!nodeStack.isEmpty())
					{
						System.out.println("this is me popping: " +nodeStack.pop().getData().toString());
					}	
				});
			}
		});
...
//			{
//				contextMenuVertex.show(sp, e.getScreenX(), e.getScreenY());
//				menuViewInfo.setOnAction(f->{
//					Alert a= new Alert(AlertType.INFORMATION,"Name:\t"+name+"\n"+"X Position:\t"+X+"\n"+"Y Position:\t"+Y+"\n");
//					a.setHeaderText("Type:\t"+type+"\n");
//					a.showAndWait();
...
//					System.out.println("end Vertex "+vertex);
//					
//					Stack<Node> nodeStack=NodeSet(vList.get(1), vertex);
//					while(!nodeStack.isEmpty())
//					{
//						System.out.println("this is me popping: " +nodeStack.pop().getData().toString());
//					}
//					//NodeSet(vList.get(0), vertex);
//					
//				});
//			}
//		});
